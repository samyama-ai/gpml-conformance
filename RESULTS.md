...
| samyama-graph | cypher | samyama v1.7.1 |
| samyama-graph-dev | cypher | samyama dev head (reports 1.7.1) |

Each cell is one exact multiset comparison, repeated 3 times to confirm the engine is deterministic.

## The map

| construct | kuzu | duckpgq | neo4j | neo4j-2026 | memgraph | apache-age | samyama-graph | samyama-graph-dev |
|---|---|---|---|---|---|---|---|---|
| `mode-walk-bounded` | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ |
| `mode-trail-bounded` | ✗ | ! | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
| memgraph | 0 | — |
| apache-age | 0 | — |
| samyama-graph | 22 | M2 lower-bound monotonicity, M3 range decomposition |
| samyama-graph-dev | 0 | — |

Total: **61 violations** across 6 graphs. Minimal reproducers are in `reproducers/`.
